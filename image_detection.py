...
MODEL_NAME = './outputs/ssd_mobile/ssd_mobile/ssd_mobile_graph_output'
PATH_TO_CKPT = MODEL_NAME + '/frozen_inference_graph.pb'
PATH_TO_LABELS = os.path.join('./outputs/ssd_mobile/ssd_mobile/training', 'object-detection.pbtxt')
...
bounding_box_count = csv.writer(open("./outputs/bounding_boxes_count.csv","w"))
